...
// class: com/tencent/tinker/commons/dexpatcher/algorithms/patch/AnnotationSetSectionPatchAlgorithm
public class AnnotationSetSectionPatchAlgorithm {
    ...
    protected int writePatchedItem(AnnotationSet patchedItem) {
        this.patchedAnnotationSetTocSec.size = this.patchedAnnotationSetTocSec.size + 1;
    ...
    protected /* synthetic */ int writePatchedItem(Comparable comparable) {
        return this.writePatchedItem((AnnotationSet)comparable);
    }
